...
extern boolean OpenInner, OpenOuter, NonReflecting, ReflectingInner, OuterSourceMass;
...
void ReflectingBoundary (Vrad, Vtheta, Rho)
...
real dt;
{
  ...
  if (ReflectingInner == YES) ReflectingBoundary(Vrad, Vtheta, Rho);
